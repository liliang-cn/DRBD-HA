...
export function HaConfigStep({
  ...
  const _mountStrategy = Form.useWatch('mount_strategy', form);
        ...
        >
          <Form form={form} layout="vertical">
            ...
            <Form.Item
              ...
              label="DRBD Resource"
              rules={[
                { required: true, message: 'Please select a DRBD resource' },
              ]}
            >
              <Select
            ...
            {/* Hidden fields for deferred LVM/ZFS storage configuration */}
            <Form.Item name="lvm_pool_id" hidden>
              <Input />
            </Form.Item>
            <Form.Item name="lvm_volume_size_gb" hidden>
              <InputNumber />
            </Form.Item>
            <Form.Item name="zfs_pool_id" hidden>
              <Input />
            </Form.Item>
            <Form.Item name="zfs_volume_size_gb" hidden>
              <InputNumber />
            </Form.Item>
            <Form.Item name="node_disks" hidden>
              <Input />
            </Form.Item>
            <Form.Item name="drbd_port" hidden>
              <InputNumber />
            </Form.Item>
            <Form.Item name="drbd_minor" hidden>
              <InputNumber />
            </Form.Item>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
                        ...
                        <Text type="secondary" className="block mb-4 text-xs">
                          Enter preferred nodes for running this service (comma
                          or space separated). The first node has the highest
                          priority.
                        </Text>
                        ...
                        >
                          <Input placeholder="Enter hostnames separated by commas or spaces" />
                        </Form.Item>
                              ...
                              help={
                                <Space direction="vertical" size="small">
                                  <Text type="secondary">
                                    ...
                                    higher priority nodes when they become
                                    available
                                  </Text>
                                  <Text type="secondary">
